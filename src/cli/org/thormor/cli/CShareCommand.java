    ...
    implements ICommand
{
        ...
        throws IOException
    {
        ...
        if (args[1].equals("message")) {
            ...
            System.out.println("Unknown share option '"+args[1]+"'");
            System.out.println("Usage:\n"+getUsage());
        }
    }
    ...
    // private
    private void doShareFile(String args[])
        throws IOException
    {
        // Get file to share.
        if (args.length < 3) {
        ...
        vault.postMessage(recip, message, CMain.getProgressMonitor());
    }

    private void doShareMessage(String args[])
        throws IOException
    {
        ...
        // upload.
        CMain.getVault()
            .postMessage(recip, message, CMain.getProgressMonitor());
    }
